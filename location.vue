                ...
                <div class="main_container margin_30">
                    <div class="details_row">
                        ...
                        <div class="details_col_9">
                            <iframe role="none" aria-hidden="true" width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"  :src="'https://maps.google.nl/maps?q=' + getPropertyAddress + '&amp;hl=en&amp;ie=UTF8&amp;t=v&amp;hnear=' + getPropertyAddress + '&amp;z=16&amp;output=embed'"></iframe>
                            <hr>
