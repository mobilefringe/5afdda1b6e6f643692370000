                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5d9d67a56e6f647b59010000/image/jpeg/1527708236000/Casas Adobes - 58.jpg" alt="" />    
                        </div>
                ...
                currentEvent : function (){
                    if(this.currentEvent != null) {
                        if (this.currentEvent.eventable_type === "Store"){
                            ...
                            if (_.includes(this.currentEvent.event_image_url_abs, 'missing')) {
                                this.currentEvent.image_url = "//codecloud.cdn.speedyrails.net/sites/5d9d67a56e6f647b59010000/image/jpeg/1527800297000/PlaceHolder4.jpg";    
                            }
                        }
                    }
                }
