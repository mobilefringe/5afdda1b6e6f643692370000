        ...
        <section class="footer_privacy ">
            <div class="main_container row">
                ...
                <div class="col-sm-8 col-md-6">
                    ...
                    <p class="footer_text"><span v-if="property.contact_phone"><a :href="'tel:' +  property.contact_phone">{{ property.contact_phone }}</a> | </span><a href="/pages/milton-privacy-policy">Privacy Policy</a> | <router-link to="/jobs" exact>Jobs</router-link> | <a :href="siteInfo.propertyManagementURL" target="_blank">{{ siteInfo.propertyManagementName }}</a></p>
                </div>
            </div>
        </section>
    </footer>
