                            ...
                            <form class="form-horizontal" action="//mobilefringe.createsend.com/t/d/s/vltuui/" method="post" @submit.prevent="validateBeforeSubmit">
                                <div class="row">
                                    <div class="col-sm-8" >
                                        ...
                                        <input v-model="form_data.name" required class="margin_20 form-control" id="cm-name" type="text" placeholder="Name">
                                    </div>
                                    <div class="col-sm-8">
                                        <label for="cm-vltuui-vltuui">Email</label>
                                        <input v-model="form_data.email" required class="margin_20 form-control" id="cm-vltuui-vltuui" type="email" placeholder="Email" id="newsletter_email">
                                    </div>
                                    <div class="col-sm-8">
